...
// ─── Assets ────────────────────────────────────────────────────────────────
const imgs = {
  searchIcon:   "https://res.cloudinary.com/dgr33gxhd/raw/upload/v1774293635/blissful-cleaning/a74bc4d9-63c4-410e-aa4b-a85994a013a2",
  accordionBtn: "https://res.cloudinary.com/dgr33gxhd/raw/upload/v1774293637/blissful-cleaning/70641020-4603-4467-bcfa-5d68ad224eb1",
};

// ─── FAQ data ───────────────────────────────────────────────────────────────
const categories = ["General", "Services", "Pricing & Booking", "Pet Friendly", "Safety"];
...
function AccordionItem({ question, answer, isOpen, onToggle }) {
  return (
    ...
    >
      ...
      >
        <span
          className="font-['Poppins',sans-serif] font-medium text-[#0f172a] text-base lg:text-[20px] lg:leading-[28px]"
        >
          {question}
        </span>
        <img
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 flex flex-col items-center gap-5">
        ...
        <div className="flex flex-col items-center gap-2.5 text-center">
          <h1 className="font-['Poppins',sans-serif] m-0 text-3xl md:text-4xl lg:text-[48px] lg:leading-[72px]">
            <span className="font-semibold text-[#0f172a]">Frequently Asked </span>
            <span className="font-normal text-[#da1b61]">Questions</span>
          </h1>
          <p
            className="font-['Satoshi',sans-serif] text-black m-0 text-sm lg:text-base lg:leading-[26px]"
          >
            Find answers to everything you need to know about our blissful cleaning services.
          </p>
        </div>
        ...
        >
          <img src={imgs.searchIcon} alt="" style={{ width: 24, height: 24, flexShrink: 0 }} />
          <input
            type="text"
            value={search}
            onChange={(e) => onSearch(e.target.value)}
            placeholder="Search for a question..."
            className="flex-1 outline-none bg-transparent font-['Inter',sans-serif] text-[#7c7c7c]"
            style={{ fontSize: 16 }}
          />
        </div>
