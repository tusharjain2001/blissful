    ...
    >
      <div className="max-w-[1440px] mx-auto px-10">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {services.map((s) => (
            <div key={s.title} className="bg-white border border-[rgba(218,27,97,0.05)] rounded-[10px] overflow-hidden w-[340px] flex flex-col shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="max-w-[1440px] mx-auto px-10 flex flex-col gap-12">
        <div className="relative rounded-[10px] overflow-hidden w-full" style={{ aspectRatio: "16/9" }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <button className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-full w-20 h-20 flex items-center justify-center hover:bg-white/30 transition-colors cursor-pointer">
